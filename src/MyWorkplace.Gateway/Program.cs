...
//     2. Authorization: secure by default; public routes are marked "anonymous", Pro routes need "plan:pro" (ADR-006).
...
//     2. Yetkilendirme: varsayılan olarak korumalı; açık rotalar "anonymous", Pro rotalar "plan:pro" ister (ADR-006).
